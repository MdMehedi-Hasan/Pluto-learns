...
const Pricing = () => {
    return (
        <div>
            <h1>Pricing</h1>
            <section className='container mx-auto gap-10 grid grid-cols-4'>
            ...
            <div className='container mx-auto'>
                <div>
                    <div tabindex="0" class="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box container">
                        <input type="checkbox" />
                        <div class="collapse-title text-xl font-medium">
                            It is a long established fact that a reader?
                        </div>
                        <div class="collapse-content ease-in-out">
